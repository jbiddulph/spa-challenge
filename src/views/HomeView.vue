      ...
      <div v-if="isAuthenticated" class="flex flex-row">
        <div class="w-2/3 pr-8">
          ...
          <p class="mb-4">
            ...
            Maecenas at congue tellus. Etiam elementum efficitur justo, ut
            posuere arcu finibus id. Sed facilisis venenatis odio in venenatis.
            Aliquam gravida ultrices purus vel convallis. Donec vulputate nulla
            quis ipsum condimentum, sed semper mi fermentum. Duis tristique ex
            vel viverra ullamcorper. Pellentesque sodales rutrum dignissim.
            Fusce vel quam sed turpis cursus interdum mattis vel turpis.
          </p>
          <p class="mb-4">
          ...
          <p class="mb-4">
            Maecenas dapibus turpis in accumsan pellentesque. Suspendisse
            faucibus elementum nunc, vitae mattis magna vehicula a. Nullam
            pulvinar, tortor ut suscipit consectetur, ex nisl semper quam,
            volutpat sagittis libero sem id nunc. Morbi porttitor pellentesque
            lectus aliquam tempus. Praesent et lectus auctor, sagittis ipsum
            quis, feugiat sem. Suspendisse lorem quam, volutpat eget lectus sit
            amet, volutpat ullamcorper purus. Suspendisse consequat ligula ut
            augue sollicitudin, a egestas nisl tristique. Mauris ut euismod
            turpis. Curabitur luctus maximus volutpat. Etiam in sapien vitae mi
            dapibus ullamcorper. Mauris erat dolor, mollis quis nulla quis,
