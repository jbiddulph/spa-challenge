<template>
  <div v-if="isAuthenticated" class="flex flex-col md:flex-row">
    <div class="m-6 w-full md:w-2/3 pr-8">
      ...
      <p class="mb-4">
        ...
        tincidunt, elit a viverra sodales, est nibh finibus dolor, id porta est
        ex quis lorem. Integer in lacinia tortor. Sed enim est, venenatis vitae
        vestibulum vel, rutrum non ipsum. Nam iaculis mauris vitae felis
        consectetur, vitae imperdiet nisl pulvinar. Praesent sollicitudin ut
        velit ac tincidunt. Pellentesque elementum, orci sit amet convallis
        maximus, mi lectus feugiat enim, a venenatis nunc lacus a nunc. Integer
        mauris neque, pharetra et massa id, tristique gravida ipsum.
      </p>
      <p class="mb-4">
        Maecenas ut diam non ex congue molestie et ac nisl. Donec eu
        pellentesque eros, et porttitor ante. Nam consectetur, turpis eu
        placerat tempor, turpis lorem ultrices orci, lobortis lacinia est massa
        quis tellus. Aenean condimentum ultrices neque a posuere. Maecenas
        pretium mauris a est malesuada, eu luctus diam tincidunt. Maecenas at
        congue tellus. Etiam elementum efficitur justo, ut posuere arcu finibus
        id. Sed facilisis venenatis odio in venenatis. Aliquam gravida ultrices
        purus vel convallis. Donec vulputate nulla quis ipsum condimentum, sed
        semper mi fermentum. Duis tristique ex vel viverra ullamcorper.
        Pellentesque sodales rutrum dignissim. Fusce vel quam sed turpis cursus
        interdum mattis vel turpis.
      </p>
      <p class="mb-4">
        Aliquam aliquam, arcu ut rhoncus pellentesque, dui sapien pretium metus,
        sed varius leo orci in elit. Curabitur a rutrum velit. Curabitur ornare
        sagittis velit id porttitor. Nunc laoreet arcu et ligula pharetra
        bibendum. Vivamus in molestie tortor. Duis bibendum vestibulum dui
        aliquet eleifend. Proin id egestas erat.
      </p>
      <p class="mb-4">
        Maecenas dapibus turpis in accumsan pellentesque. Suspendisse faucibus
        elementum nunc, vitae mattis magna vehicula a. Nullam pulvinar, tortor
        ut suscipit consectetur, ex nisl semper quam, volutpat sagittis libero
        sem id nunc. Morbi porttitor pellentesque lectus aliquam tempus.
        Praesent et lectus auctor, sagittis ipsum quis, feugiat sem. Suspendisse
        lorem quam, volutpat eget lectus sit amet, volutpat ullamcorper purus.
        Suspendisse consequat ligula ut augue sollicitudin, a egestas nisl
        tristique. Mauris ut euismod turpis. Curabitur luctus maximus volutpat.
        Etiam in sapien vitae mi dapibus ullamcorper. Mauris erat dolor, mollis
        quis nulla quis, consequat rutrum diam.
      </p>
    </div>
  ...
  <div v-if="!isAuthenticated">
    <h3>
      Welcome to the CRM - you are not logged in
      {{ this.token }}
    </h3>
  </div>
</template>
