<template>
  <nav>
    <div v-if="isAuthenticated">
      ...
      <div v-if="loggedUser.hasGallery">
        <router-link
          to="/galleries"
      ...
      <div v-if="loggedUser.hasCompanies">
        <router-link
          to="/companies"
          class="flex items-center space-x-2 py-3 px-4 hover:bg-gray-600 rounded"
        >
      ...
      <div v-if="loggedUser.hasContacts">
        <router-link
          to="/contacts"
          class="flex items-center space-x-2 py-3 px-4 hover:bg-gray-600 rounded"
        >
